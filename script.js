    ...
    'dong': {
      ...
      text: `
        <p>
          ...
          『네모 네모 네모 네모 네모 네모』</br>
          2025. 03. 03. 월요일부터</br>
2025. 03. 07. 금요일까지</br>
오전 10시부터 오후 6시까지</br>
홍익대학교 현대미술관 제 1관 문헌관 4층</br></br>
    ...
    'bok': {
      ...
      text: `
        <p>
          ...
          <a href="https://www.instagram.com/p/DB8qc9PTNyZ/" target="_blank">  ▶︎ <span class="kor hype">《복도는 복도다》 전시</span></a><br/><br/>
          
          ▫️전시 제목 : 복도는 복도다<br/>
▫️전시 기간 : 2024년 11월 11일(월) – 2024년 11월 22일(금)<br/>
▫️전시 장소 : 한국예술종합학교 미술원 2층 강태희갤러리 (서울 성북구 화랑로 32길 146-37)<br/>
▫️기획 : 김채림 @cherrym_i , 김현빈 @hbeing.a , 박정민 @greemrockp<br/>
▫️참여작가 : 심온 @sim_on0208 , 이지오 @llulmu , 임수연 @suuuu_ya__ , 최연우 @chldusdn9 , 최지아 @zlor210 , 최지이 @im.zlol<br/>
▫️포스터, 계단 그래픽 디자인 : 강혜민 @minx3.3<br/><br/>

강태희 갤러리(복도 갤러리)에서 유동성의 공간인 복도는 갤러리가 되며 ‘머무르는 곳’으로 변한다. 그러나 누군가는 이 앞에 걸음을 멈추고, 또 다른 이는 그저 지나칠 뿐이다. 이처럼 ‘복도’는 미술원의 하얀 복도인 동시에 갤러리인 교차점에 위치하며, 쉽게 하나로 정의할 수 없는 모호함을 가진다. 우리는 일상적 공간과 특정 용도의 공간이 부딪치는 바로 여기에서 ‘복도 갤러리’라는 장소에 물음을 던지고자 한다. 각 예술을 구분하고 정의하는 것은 무엇인가? 우리 모두 고개를 갸웃거리지만, 어쩌면 그 열쇠는 ‘장소성’이 쥐고 있을지도 모른다.<br/><br/>

《복도는 복도다》 전시는 회화/설치, 영상매체/판화/사진/건축/디자인/기타로 구분되는 복도 갤러리 지원서 속 분야의 ‘기타’ 란에 주목하며, ‘기타’ 분야를 ‘복도’로 치환해 예술을 뒤섞고 교차시킨다. 즉, ‘미술’로 규정되기 보다 그 모든 모호성을 이용하는 ‘기타’로 존재하며 새로운 예술의 가능성을 실험하는 것이다. 기획자와 6개원의 존재들은 ‘복도’라는 장소성을 어떻게 해석할 것인가. 자신의 분야에 얽매이지 않고 예술을 어떻게 표현하고, 복도를 거니는 존재는 그에 어떻게 감응하고 ‘연결’의 경험과 감정을 인식할 수 있는가? 함께하며 ‘지나가기’를 수행하는 관객 또한 예술의 주체로서 참여하며 ‘복도’를 미술로, 음악으로, 무용으로, 연기로 또 새로운 예술로 끊임없이 새롭게 이해하고 고민해 주길 소망한다. 이를 통해 전시가 사유의 결과물을 제시하는 것이 아닌 사유의 진행형으로 펼쳐지길 바란다

우리가 마주한 예술적 고민을 ‘유동성의 공간’인 복도에 풀어놓아 모두에게 흐르고 또 끊임없는 물음표가 생겨나길 소망한다. 그리고 그 물음을 구하기에 앞서, 그 자체로 아름다울 모든 존재와 예술이 교차하는 예술의 패턴을 여기, 복도에 꺼내 놓았다.
    ...
    'ggol': {
      ...
      text: `
        <p>
          ...
          《네모 네모 네모 네모 네모 네모: ■■■연구회》<br/>

■■■연구회 안에는 무엇이든 들어갈 수 있다. 회원들이 자유롭게 상상한 ■■■연구회의 글자를 보자. ■■■연구회는 꼴과 어감이 비슷한 음절의 단어로 한글꼴연구회의 유쾌한 가능성을 보여준다.
